...
<div class="row d-sm-flex justify-content-center">
    <div class="col-xl-5 col-lg-5">
        <div class="card-nota1">
            ...
            <div class="my-1">
                <p class="text-black-100 mt-1 mb-1 small split-para">{{ $transaksi->mulai }}<span
                        class="text-right">{{ $transaksi->selesai }}</span></p>
            </div>
            <div class="my-1">
                <p class="text-black-100 mt-1 mb-1 small split-para">No. Invoice<span
                        class="text-right">{{ $transaksi->no_invoice }}</span></p>
            </div>
            <div class="my-1">
            ...
            <div class="my-1">
                <p class="text-black-100 mt-1 mb-1 small split-para">Collected By<span
                        class="text-right">{{ $transaksi->collected_by }}</span></p>
            </div>
            <!-- Divider -->
            ...
            <div class="my-1 col-pelanggan">
                <div id="textbox">
                    <p class="text-black-400 mt-n1 mb-1 alignleft">{{ $transaksi->layanan }}</p>
                    <p class="text-black-400 mt-n1 mb-1 aligncenter">({{ $transaksi->berat }} KG)</p>
                    <p class="text-black-400 mt-n1 mb-1 alignright">Rp. {{ $transaksi->total_biaya }}</p>
                </div>
            </div>
            <div class="my-1">
                <p class="text-gray-600 mt-1 mb-1 ml-5 split-para">{{ $transaksi->layanan }} Service</p>
                <p class="text-gray-600 mt-1 mb-4 ml-5 split-para">{{ $hari }} Hari</p>
                <p class="text-gray-600 mt-1 mb-1 ml-5 split-para">*{{ $transaksi->keterangan }}</p>
            </div>
            <!-- Divider -->
            <hr class="sidebar-divider col-10 my-2">
            <div class="my-1">
                <p class="text-black-1000 mt-1 mb-1 split-para">Total<span class="text-right">Rp.
                {{ $transaksi->total_biaya }}</span></p>
            </div>
            <!-- Divider -->
            <hr class="sidebar-divider col-10 my-2">
            <div class="my-1">
                <p class="text-black-100 mt-1 mb-1 split-para">Pembayaran Saat Ini<span
                        class="text-right">Rp. {{ $transaksi->biaya_sekarang }}</span></p>
            </div>
            <div class="my-1">
                <p class="text-black-100 mt-1 mb-1 split-para">Sisa Pembayaran<span
                        class="text-right text-black-400">Rp. {{ $transaksi->sisa_biaya }}</span></p>
            </div>
            <div class="my-1">
                <p class="text-black-100 mt-1 mb-1 split-para">Pembayaran Via<span
                        class="text-right">{{ $transaksi->via }}</span></p>
            </div>
            <div class="my-1">
                @if($transaksi->sisa_biaya == 0)
        ...
        <div class="row col-pelanggan mt-3 d-flex justify-content-between align-items-center">
            <div class="form-group col-6">
                <a href="{{ "exportpdf_".$transaksi->no_invoice }}" class="btn btn-danger "><img class="mr-2" src="assets/img/image/pdf.png" width="25px"> Download</a>
            </div>
            <div class="form-group col-6 text-right mr-n4">
                <a href="{{ "sendemail_kiloan_".$transaksi->no_invoice }}" class="btn btn-success"><img class="mr-3" src="assets/img/image/gmail.png" width="30px"><span class="mr-4 text-right">Kirim</span></a>
            </div>
        </div>
    </div>
